...
$site_top = "http://www.darwin-ap.co.jp/lp";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info-am@darwin-ap.co.jp";
...
$Referer_check_domain = "darwin-ap.co.jp";
...
$thanksPage = "http://www.darwin-ap.co.jp/lp/thanks.html";
...
$require = array('個人情報取扱い同意書および注意事項','お名前','住所','お電話番号','メールアドレス','年収','ご職業');
...
$refrom_name = "ダーウィンアセットパートナーズ株式会社";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問合せいただき、ありがとうございました。";
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('住所','お電話番号','メールアドレス');
